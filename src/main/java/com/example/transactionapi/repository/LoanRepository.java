...
public interface LoanRepository extends JpaRepository<Loan, Integer> {
    ...
    Page<Loan> findAllByUid(Integer uid, Pageable pageable);
    Page<Loan> findAllByUidAndRequesttimeBetween(Integer uid, LocalDateTime dateStart, LocalDateTime dateEnd, Pageable pageable);
}